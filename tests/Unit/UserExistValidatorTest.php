...
class UserExistValidatorTest extends TestCase
{
    ...
    public function test_does_not_exist_returns_true_when_user_does_not_exist(): void
    {
        $email = new Email('newuser@example.com');
        ...
        $this->assertTrue($this->validator->doesNotExist($email));
    }

    public function test_does_not_exist_returns_false_when_user_exists(): void
    {
        $email = new Email('existing@example.com');
        ...
        $this->assertFalse($this->validator->doesNotExist($email));
    }

    public function test_validate_with_invalid_email_format(): void
    {
        // This test verifies that Email value object validation happens first
        $this->expectException(\InvalidArgumentException::class);

        new Email('invalid-email-format');
    }

    public function test_multiple_validations_with_same_email(): void
    {
