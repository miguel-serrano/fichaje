...
<div class="px-4 sm:px-6 lg:px-8">
    ...
    <!-- Sección de Todos los Fichajes (All Time Entries) -->
    <div class="mt-8">
        <div class="bg-white shadow sm:rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <h3 class="text-lg font-medium leading-6 text-gray-900 mb-4">Todos los Fichajes</h3>
                @if(count($allRegistros) > 0)
                    <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-300">
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                ...
                                <tr>
                                    <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">{{ $registro->id() ? $registro->id()->getValue() : 'N/A' }}</td>
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $registro->entrada()->format('Y-m-d H:i:s') }}</td>
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $registro->salida() ? $registro->salida()->format('Y-m-d H:i:s') : 'Abierto' }}</td>
